    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <img src={`${basePath}/logo.svg`} alt="Homegrown Hoops" className="h-12 mx-auto mb-4" />
          <h1 className="font-display text-3xl uppercase text-white tracking-wide">Sign In</h1>
          <p className="text-muted-foreground text-sm mt-2">Atlantic Canada's Youth Basketball Platform</p>
        </div>
        <div className="bg-card rounded-xl p-8 border border-border shadow-2xl space-y-4">
          <button
            onClick={handleGoogle}
            disabled={loading || !isLoaded}
            className="w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-lg border border-border bg-background hover:bg-muted transition-colors font-semibold text-sm text-foreground disabled:opacity-60 disabled:cursor-not-allowed"
          >
