...
export const ARCHETYPES: {
...
}[] = [
  {
    ...
    label: "Uncharted",
    icon: Compass,
    tagline: "Your story has not been written yet — step on the court and begin.",
  ...
  },
  {
    ...
    label: "The Mainstay",
    icon: Anchor,
    tagline: "The go-to scorer — when points are needed, this player delivers.",
  ...
  },
  {
    ...
    label: "The Deep",
    icon: Target,
    tagline: "The three pointer is this player's signature weapon.",
  ...
  },
  {
    ...
    label: "The Climb",
    icon: Mountain,
    tagline: "Still writing their story — consistent contributor whose best games are ahead.",
  ...
  },
  {
    ...
    label: "The Warden",
    icon: Shield,
    tagline: "Steals are this player's weapon — they make the game difficult for every ball handler.",
  ...
  },
  {
    ...
    label: "The Wall",
    icon: Castle,
    tagline: "Shot blocking defines this player — they protect the paint and change shots at the rim.",
  ...
  },
  {
    ...
    label: "The Spark",
    icon: Flame,
    tagline: "Maximum impact in minimum minutes — this player changes the game off the bench.",
