...
export const ARCHETYPES: {
  ...
  },
  {
    ...
    label: "The Vortex",
    icon: Wind,
    tagline: "Rebounds dominant. Earned when rebounds per game is your highest personal per-game category — you control the glass more than any other contribution.",
  ...
  },
  {
    ...
    label: "The Current",
    icon: Zap,
    tagline: "Assists and playmaking. Earned when assists per game is your highest personal per-game category — setting others up is your primary contribution on the court.",
  ...
  },
  {
    ...
    label: "The Deep",
    icon: Target,
    tagline: "Three-point specialist. Earned when three pointers per game is your highest personal per-game category — you operate from range that demands defensive respect.",
  ...
  },
  {
    ...
    label: "The Climb",
    icon: Mountain,
    tagline: "Versatile contributor. Earned when no single stat category stands clearly above the rest — a well-rounded player whose impact spreads across the box score.",
