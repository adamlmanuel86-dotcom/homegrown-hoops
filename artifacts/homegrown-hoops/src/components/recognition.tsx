...
export const TIDES: {
...
}[] = [
  {
    ...
    description: "The team's top scorer for the season. The water rose highest here.",
    howToEarn: "Finish the season as the top scorer on your team.",
    threshold: "Top scorer on your team for the season",
  },
  {
    id: "rising_tide",
    label: "Rising Tide",
    ...
    description: "The biggest statistical leap from one season to the next.",
    howToEarn: "Show the most improved player stats comparing this season to last season.",
    threshold: "Most improved player stats season over season",
  },
  {
    id: "the_keeper",
    label: "The Keeper",
    ...
    description: "The anchor on the glass. Led the league in rebounds for the full season.",
    howToEarn: "Finish the season as the league's leading rebounder.",
    threshold: "Led the league in rebounds for the season",
  },
  {
    id: "lighthouse",
    label: "Lighthouse",
  ...
  },
  {
    ...
    description: "One night that no one in the league could touch. The highest single-game scoring performance of the season.",
    howToEarn: "Record the highest single-game scoring total in the league for the season.",
    threshold: "Highest single game scoring performance of the season",
  },
  {
    id: "shoreline",
    label: "Shoreline",
    ...
    description: "Every game, every night. The most dependable presence on the schedule.",
    howToEarn: "Play every single game of the season.",
    threshold: "Played every single game of the season",
  },
  {
    id: "the_source",
    label: "The Source",
    ...
    description: "The origin of every play. Led the league in assists for the full season.",
    howToEarn: "Finish the season as the league's assist leader.",
    threshold: "Season assist leader",
  },
  {
    id: "the_crest",
    label: "The Crest",
    ...
    description: "The MVP. The highest combined points, rebounds and assists per game all season.",
    howToEarn: "Finish the season with the highest combined points, rebounds and assists per game.",
    threshold: "MVP — highest combined PPG + RPG + APG for the season",
  },
];
...
export const ARCHETYPES: {
...
}[] = [
  {
    ...
    label: "Uncharted",
    icon: Compass,
    tagline: "Your story hasn't been written yet. Play games, earn stats, and discover who you are on the court. This is where every player begins.",
  ...
  },
  {
    ...
    label: "The Mainstay",
    icon: Anchor,
    tagline: "Consistent points scorer. Earned by averaging the highest points per game on your team across the season.",
  ...
  },
  {
    ...
    label: "The Vortex",
    icon: Wind,
    tagline: "Rebounds dominant. Earned by leading your team in total rebounds for the season.",
  ...
  },
  {
    ...
    label: "The Current",
    icon: Zap,
    tagline: "Assists and playmaking. Earned by leading your team in total assists for the season.",
  ...
  },
  {
    ...
    label: "The Deep",
    icon: Target,
    tagline: "Three point specialist. Earned by making the most three pointers on your team for the season. Operates from range that demands respect.",
  ...
  },
  {
    ...
    label: "The Climb",
    icon: Mountain,
    tagline: "Improving across points and rebounds. Earned by showing the biggest statistical improvement from the first half to the second half of the season.",
  ...
  },
  {
    ...
    label: "The Spark",
    icon: Flame,
    tagline: "Changes the game in limited minutes. Earned by having the highest points per minute ratio on the team among players averaging under 15 minutes per game.",
